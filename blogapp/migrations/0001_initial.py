    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('best_comment', models.BooleanField(default=False, verbose_name='Best Comment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ManyToManyField(to='blogapp.category', verbose_name='Category')),
                ('comments', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blogapp.comments', verbose_name='Comments')),
            ],
        ),
    ]
